...
# Form implementation generated from reading ui file 'TTS_Layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ModelCombo = QtWidgets.QComboBox(self.tab)
        ...
        self.LoadTTSButton = QtWidgets.QToolButton(self.gridWidget)
        self.LoadTTSButton.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.LoadTTSButton.setObjectName("LoadTTSButton")
        self.gridLayout_2.addWidget(self.LoadTTSButton, 1, 4, 1, 1)
        ...
        self.log_window2 = QtWidgets.QTextEdit(self.tab_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Voice Model:"))
        self.label.setText(_translate("MainWindow", "Browse"))
        self.LoadTTSButton.setText(_translate("MainWindow", "..."))
        ...
        self.label_6.setText(_translate("MainWindow", "v0.3a"))
